            ...
            <el-table-column 
                ...
                <template slot-scope="scope">
                    <div>
                        ...
                        <div v-else-if="item.propName == 'status'">
                            <span>{{ scope.row[item.propName]=='0' ? '测试机':'辅助机' }}</span>
                        </div>
...
export default {
    ...
    methods: {
        ...
        cellClick(row, column, cell, event) {
            if(column.label !== '操作' && column.label !== 'Pease链接' && column.label !== '测试人员' && column.label !== '设备'){
