<template>
    <div class="performance-application">
        <div class="application-title">手游弱网测试</div>
        <div class="container">
...
export default {
    ...
    watch: {
        $route(to, from) {
            if(to.path == "/mtl_test_platform/page/expertServices/weaknet"){
                // 表单数据清空
    ...
    methods: {
        ...
        async getData(){
            ...
            if (path == "/mtl_test_platform/page/expertServices/weaknet") {
                //新申请
                this.editType = "add";
                this.applicationFormList.contact_person = this.userEmail;
                this.canShowForm = true;
            } else if (path == "/mtl_test_platform/page/expertServices/weaknetTestDetail") {
                //查看
                this.editType = "read";
        ...
        getOldApplication() {
            ...
            if (this.applicationId == undefined) {
                ...
                let list = { test_type: 22, id: this.applicationId, table_name: this.$route.query.table_name };
        ...
        axiosFormData(formData) {
            ...
            if (this.editType == "edit") {
                //编辑
                postApp = "/mobileWeaknetTest/update_expert_test_apply";
                operation = "编辑申请";
