<template>
    <div class="performance-application">
        <div class="application-title">隐私合规测试</div>
        <div class="container">
            ...
            <div class="main-container">
                ...
                <el-form 
                    ...
                    <!-- <div class="area-div">
                        ...
                        <div style="width:100%;">
                            <input-and-upload v-if="editType!='read'" ref="testCaseRef" :select-data="playData"/>
                            <div v-else>
                    ...
                    <el-row :gutter="30">
                        <el-col :span="12">
                            <div class="area-div">
                                <div class="title-div">
                                    <span class="title-span">产品说明</span>
                                    <hr>
                                </div>
                                <div style="width:100%;">
                                    <input-and-upload v-if="editType!='read'" ref="testCaseRef" :select-data="productDescription"/>
                                    <div v-else>
                                        <input-and-upload-read 
                                            :text="oldData.test_case" 
                                            :file="oldData.test_case_file" 
...
export default {
        ...
        return {
            ...
            playData: {
                ...
                selectDict: {
                    textarea: {
                        type: "textarea",
                        placeholder: "请填写玩法说明，包含海发合规/国内合规、核心玩法、产品接入SDK列表、最低支持Android版本、是否支持模拟器",
                        value: "",
                    },
                    file: {
                        type: "fileArr",
            ...
            productDescription: {
                radioOption: [
                    { value: "textarea", label: "直接填写" },
                    { value: "file", label: "上传产品说明" }
                ],
                selectDict: {
                    textarea: {
                        type: "textarea",
                        placeholder: "请填写产品说明，包含海发合规/国内合规、核心玩法(着重，例如主要玩法功能、容易遗漏的玩法功能、新增玩法功能)、产品接入SDK列表、最低支持Android版本、是否支持模拟器",
                        value: "",
                    },
                    file: {
                        type: "fileArr",
    ...
    methods: {
        ...
        async getData(){
            ...
            if (path == "/mtl_test_platform/page/expertServices/privacy") {
                //新申请
                this.editType = "add";
