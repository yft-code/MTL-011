        ...
        <el-card class="box-card">
            <div slot="header" class="clearfix">
                ...
                <div class="decorate-title">
                    备注
                    <!-- <i v-if="!remarkFlag && !isPreview && projectCode !== 'all'"  -->
                    <i v-if="!remarkFlag && !isPreview" 
            ...
            <div class="card-content-div">
                <div class="task-content-div">
                    <div v-if="!remarkFlag" style="margin-left: 10px">
                        <span class="comment">{{taskDetail['report_remarks'] ? taskDetail['report_remarks'] : '无'}}</span>
                    </div>
                    <div v-else  style="margin-left: 10px">
                        <el-input v-model="taskDetail['report_remarks']" type="textarea" :autosize="{ minRows: 2}" style="width: 90%" placeholder="请填入备注"></el-input>
