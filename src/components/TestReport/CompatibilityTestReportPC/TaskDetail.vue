            ...
            <div class="card-content-div">
                ...
                <div class="task-content-div">
                    <div style="width:100%">
                        ...
                        <!-- <div v-if="isPreview && taskDetail['high_risk_items']" style="margin-top: 0.6rem;">
                            <span class="testInfoTitle">高风险项</span>
                        ...
                        <div v-if="isPreview && taskDetail['report_remarks']" style="margin-top: 0.6rem;">
                            <span class="testInfoTitle">备&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;注</span>
                            <span style="color:#666666;">
                                <span>
                                    {{ taskDetail['report_remarks'] }}
                                </span>
                            </span>
                        </div> -->
                    </div>
