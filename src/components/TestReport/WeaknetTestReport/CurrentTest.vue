...
<script> 
import ReportTable from '@/components/TestReport/WeaknetTestReport/ReportTable'
import DeviceDescription from '@/components/TestReport/WeaknetTestReport/DeviceDescription'
export default {
    components: {
        ReportTable,
        DeviceDescription
